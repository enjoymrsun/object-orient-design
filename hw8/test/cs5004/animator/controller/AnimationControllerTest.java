...
public class AnimationControllerTest {
  private AnimationController controllerForSVG;
  private AnimationController controllerForTextual;
  ...
  public void setUp() throws Exception {
    ...
    controllerForSVG = new AnimationController(modelForSVG, svgView);
    controllerForTextual = new AnimationController(modelForTextual, textualView);
  }
  ...
  public void testDisplay() throws Exception {
    ...
    controllerForSVG.display(outputSVGFile, 4);
    controllerForTextual.display(outputTextualFile, 5);
